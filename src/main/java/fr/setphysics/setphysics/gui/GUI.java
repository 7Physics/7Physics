...
public class GUI {
	...
	/*
	 * ***************************************** * Création du MenuBar en haut de la
	 * fenêtre * *****************************************
	 */
	...
	public GUI() {
		...
		/*
		 * *************************************** * Initialisation des Panels de la
		 * fenêtre * ***************************************
		 */
		...
		/*
		 * ******************************************** * Gestion du contenu du Panel en
		 * haut à gauche * La scene de rendu 3D *
		 * ********************************************
		 */
		...
		/*
		 * ******************************************** * Gestion du contenu du Panel en
		 * bas à gauche * La gestion des objets présents dans la scene *
		 * ********************************************
		 */
		...
		/*
		 * ******************************************** * Gestion du contenu du Panel en
		 * haut à droite * Ajout et création d'objets *
		 * ********************************************
		 */
		...
		/*
		 * ******************************************* * Gestion du contenu du Panel en
		 * bas à droite * Onglets des paramètres des objets *
		 * *******************************************
		 */
		...
		/*
		 * ************************************************ * Gestion de fermeture de la
		 * fenêtre avec la croix * ************************************************
		 */
		fenetre.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		/*
		 * ******************************************* * Ajout du contenu dans les
		 * différents Panels * *******************************************
		 */

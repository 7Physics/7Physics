...
On bougeait la scène et pas la caméra mais ducoup on a changé

\subsection{Rendu pixelisé}
images étaient trop pixélisées 
Solution : utilisation du Anti-aliasing
...
Enfin, l'équipe se réuni une dernière fois pour dans le sprint pour analyser le déroulement du sprint. Cette analyse permet d'avoir
le ressenti réel de chaque membre de l'équipe dans le projet. Cette réunion nous a permis de définir les défauts du sprint réalisé 
et de les corriger lors du prochain.

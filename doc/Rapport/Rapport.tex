...
\warningbox{Ce système de détection de collision n'est basée que sur la boîte englobant un objet 3D. Ainsi un cône, une sphère ou un cube auront tous une boîte de collision en forme de pavé droit. Leur forme réelle n'est donc pas prise en compte dans le calcul.}
...
\notebox{Vous pourrez retrouver l'intégralité des diagrammes de classes dans \hyperlink{annexe}{\color{blue}l'annexe A.}}

...
Enfin, l'équipe se réunissait une dernière fois pour dans le sprint pour analyser le déroulement du sprint. Cette analyse permet d'avoir
le ressenti réel de chaque membre de l'équipe dans le projet. Cette réunion faisait ressortir les défauts du sprint réalisé 
afin de les corriger lors du prochain.

...
\warningbox{Ce système de détection de collision n'est basée que sur la boîte englobant un objet 3D. Ainsi un cône, une sphère ou un cube auront tous une boîte de collision en forme de pavé droit. Leur forme réelle n'est pas prise en compte dans le calcul.}
